 ...
 */
template<typename T>
class PositionMeasurement : public filters::Vector<T, 2>
{
public: 
...
class PositionMeasurementModel : public filters::LinearizedMeasurementModel<State, Measurement>
{
public:
    ...
    typedef  example::PositionMeasurement<typename Measurement::Scalar> M;
    ...
    M h(const S& x) const
    {
        ...
        filters::Vector<T, 2> position = x.template head<2>();
        
        // Distance of robot to landmark 1
        filters::Vector<T, 2> delta1 = position - landmark1;
        measurement.d1() = std::sqrt( delta1.dot(delta1) );
        
        // Distance of robot to landmark 2
        filters::Vector<T, 2> delta2 = position - landmark2;
...
protected:
    ...
    filters::Vector<T, 2> landmark1;
    
    //! Position of landmark 2 given as (x,y)-measurement
    filters::Vector<T, 2> landmark2;

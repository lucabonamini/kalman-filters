 ...
 */
template<typename T>
class State : public filters::Vector<T, 3>
{
public: 
    //! X-position
 ...
 */
template<typename T>
class Control : public filters::Vector<T, 2>
{
public:    
    //! Velocity
...
class SystemModel : public filters::LinearizedSystemModel<State, Control>
{
public:
    ...
    typedef example::Control<typename Control::Scalar> C;
